...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex bg-white">
      ...
      <div className="hidden lg:flex w-1/2 bg-black flex-col justify-between p-12">
        ...
        <div>
          <p className="text-4xl font-semibold text-white leading-snug tracking-tight">
            Gestión de recursos<br />para tu local.
          </p>
          <p className="text-[#86868b] mt-4 text-base">
            Control de horas, recursos y equipo en un solo lugar.
          </p>
        </div>
      ...
      {/* Right panel */}
      <div className="flex-1 flex items-center justify-center px-6 bg-[#f5f5f7]">
        <div className="w-full max-w-sm">
          ...
          <h1 className="text-2xl font-semibold text-[#1d1d1f] tracking-tight mb-1">
            Iniciar sesión
          </h1>
          <p className="text-[#6e6e73] text-sm mb-8">Bienvenido de nuevo</p>
          ...
          <p className="mt-6 text-center text-sm text-[#6e6e73]">
            ¿No tienes cuenta?{' '}
            <Link to="/register" className="text-[#0066cc] hover:text-[#0077ed] font-medium">
              Regístrate
            </Link>
          </p>
        </div>
